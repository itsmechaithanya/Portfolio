      ...
      <div className='flex flex-col items-center justify-center mt-[5vh]'>
        <div className='h-fit flex justify-center '>
          <div className='w-[90vw] h-fit bg-[#FFF1F1] border border-[#D7D7D7] rounded-[8vh] px-[10vh] py-[10vh]'>
            ...
            <div className='flex gap-[3vw] mt-[5vh]'>
              <Link to="https://codex-chi-tan.vercel.app"><div className=''><h1 className='text-white bg-black px-[2vw] py-[1.5vh] rounded-[1vh] flex items-center cursor-pointer'>Visit the website <img loading='lazy' className='' src={ArrowUp} alt="" /></h1></div></Link>
            ...
            <div>
              <div className='flex mt-[8vh]'>
                <div className='w-1/2'><img loading='lazy' className='w-[20vw] h-full ml-[5vw]' src={codexm} alt="CodeX Club" /></div>
        ...
        <div className='h-fit flex justify-center mt-[5vh]'>
          <div className='w-[90vw] h-fit bg-[#F1F5FF] border border-[#D7D7D7] rounded-[8vh] px-[10vh] py-[10vh]'>
            ...
            <div className='flex gap-[3vw] mt-[5vh]'>
              <Link to="https://agromate.vercel.app"><div className=''><h1 className='text-white bg-black px-[2vw] py-[1.5vh] rounded-[1vh] flex items-center cursor-pointer'>Visit the website <img loading='lazy' className='' src={ArrowUp} alt="" /></h1></div></Link>
              <div className='flex items-center justify-center gap-[1vw]'><div className='h-[1vh] w-[1vh] bg-[#64C200] rounded-[10vh]'></div><h1>Completed</h1></div>
            </div>
            <div className='flex items-center justify-center mt-[5vh]'>
              <div className='w-[80vw] rounded-[5vh] overflow-hidden'>
            ...
            <div>
              <div className='flex mt-[8vh]'>
                <div className='w-1/2'><img loading='lazy' className='w-[20vw] h-full ml-[5vw]' src={agrom} alt="Agromate" /></div>
                <div className='w-1/2 flex items-center '>
        ...
        <div className='h-fit flex justify-center mt-[5vh]'>
          <div className='w-[90vw] h-fit bg-[#F5FAEF] border border-[#D7D7D7] rounded-[8vh] px-[10vh] py-[10vh]'>
            ...
            <div className='flex gap-[3vw] mt-[5vh]'>
              <Link to="https://juicerobo-beta.vercel.app"><div className=''><h1 className='text-white bg-black px-[2vw] py-[1.5vh] rounded-[1vh] flex items-center cursor-pointer'>Visit the website <img loading='lazy' className='' src={ArrowUp} alt="" /></h1></div></Link>
              <div className='flex items-center justify-center gap-[1vw]'><div className='h-[1vh] w-[1vh] bg-[#64C200] rounded-[10vh]'></div><h1>Completed</h1></div>
            </div>
            <div className='flex items-center justify-center mt-[5vh]'>
              <div className='w-[80vw] rounded-[5vh] overflow-hidden'>
            ...
            <div>
              <div className='flex mt-[8vh]'>
                <div className='w-1/2'><img loading='lazy' className='w-[20vw] h-full ml-[5vw]' src={juim} alt="Agromate" /></div>
                <div className='w-1/2 flex items-center '>
        ...
        <div className='h-fit flex justify-center mt-[5vh]'>
          <div className='w-[90vw] h-fit bg-[#FFF9F1] border border-[#D7D7D7] rounded-[8vh] px-[10vh] py-[10vh]'>
            ...
            <div className='flex gap-[3vw] mt-[5vh]'>
              <Link to="https://woxsen-reimagine-round2.vercel.app"><div className=''><h1 className='text-white bg-black px-[2vw] py-[1.5vh] rounded-[1vh] flex items-center cursor-pointer'>Visit the website <img loading='lazy' className='' src={ArrowUp} alt="" /></h1></div></Link>
              <div className='flex items-center justify-center gap-[1vw]'><div className='h-[1vh] w-[1vh] bg-[#64C200] rounded-[10vh]'></div><h1>Completed</h1></div>
            </div>
            <div className='flex items-center justify-center mt-[5vh]'>
            ...
            <div>
              <div className='flex mt-[8vh]'>
                <div className='w-1/2'><img loading='lazy' className='w-[20vw] h-full ml-[5vw]' src={woxm} alt="Agromate" /></div>
                <div className='w-1/2 flex items-center '>
        ...
        <div className='h-fit flex justify-center mt-[5vh]'>
          <div className='w-[90vw] h-fit bg-[#F1F5FF] border border-[#D7D7D7] rounded-[8vh] px-[10vh] py-[10vh]'>
            ...
            <div className='flex gap-[3vw] mt-[5vh]'>
              <Link to="https://ui-fry-rho.vercel.app"><div className=''><h1 className='text-white bg-black px-[2vw] py-[1.5vh] rounded-[1vh] flex items-center cursor-pointer'>Visit the website <img loading='lazy' className='' src={ArrowUp} alt="" /></h1></div></Link>
              <div className='flex items-center justify-center gap-[1vw]'><div className='h-[1vh] w-[1vh] bg-[#64C200] rounded-[10vh]'></div><h1>Completed</h1></div>
            </div>
            <div className='flex items-center justify-center mt-[5vh]'>
              <div className='w-[80vw] rounded-[3vh] overflow-hidden'>
            ...
            <div>
              <div className='flex mt-[8vh]'>
                <div className='w-1/2'><img loading='lazy' className='w-[20vw] h-full ml-[5vw]' src={uim} alt="Agromate" /></div>
                <div className='w-1/2 flex items-center '>
