      ...
      >
        <div className='flex justify-between items-center w-full'>
          ...
          <div className='hidden md:flex items-center gap-[3vw] text-[2.2vh]'>
            ...
            <a href="https://drive.google.com/file/d/1O6y6o5LCgHVFJzhCdZraF5WA4-psw1wS/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='nav-item relative group overflow-hidden'>
        ...
        <div ref={menuRef} className='hidden overflow-hidden md:hidden w-full'>
          <div className='flex flex-col gap-[3vh] text-[2.5vh] mt-[4vh] mb-[2vh] text-center font-semibold'>
            ...
            <a href="https://drive.google.com/file/d/1O6y6o5LCgHVFJzhCdZraF5WA4-psw1wS/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='mobile-nav-item py-2 active:bg-white/10 rounded-lg'>
              Resume
            </a>
