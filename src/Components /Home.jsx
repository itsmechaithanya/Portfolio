    ...
    <div>
      <div className="w-full">
        <div>
         ...
         <div className='bg-[#EFF0FF] h-auto w-full'>
            <div 
            // data-scroll data-scroll-speed="0.3"
            className='h-screen w-full absolute flex bg-[#EFF0FF] rounded-t-[5vh]'>
